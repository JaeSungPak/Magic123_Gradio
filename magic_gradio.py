...
def generate_mesh(input_image):
    ...
    cmd_2 = f"bash scripts/magic123/run_both_priors.sh 1 nerf dmtet {input_path} 1 1"
    ...
    output_name = f"./out/magic123-nerf-dmtet/magic123_input_nerf_dmtet/mesh/mesh.obj"
    return output_name
